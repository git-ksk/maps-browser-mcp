...
- [WebRTC Human Takeover](webrtc-human-takeover.md) — macOS + iPhone Safari setup, Handoff helper build, authenticated operator origin, direct/TURN behavior, and recovery
