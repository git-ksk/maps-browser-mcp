...
- Advance the pinned `mcp-execution-handoff` integration to the v0.4.1 source release (`19692aba691249dbff6e09c39da0e8cde4b803b6`), including Linux host readiness, packaged helper fixes, mobile input convergence, recoverable managed-WSS session liveness, deterministic completion/authority cleanup, and the Desktop Session display boundary.
