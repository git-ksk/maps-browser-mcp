...
- Advance the pinned `mcp-execution-handoff` integration to the v0.4.2 source release (`7ada84749af85bf98cdf6fa2a8b244804683120d`). This retains the v0.4.1 Linux/mobile/WSS/Desktop Session baseline and additionally fences expired credential-safe external Human surfaces so stale cached takeover locators are never reused (#226).
